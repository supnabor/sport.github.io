"use strict";
"use strict";function documentActions(e){var t=e.target;if(t.closest(".burger__button")&&document.documentElement.classList.toggle("burger__open"),t.closest("[data-goto]")){document.documentElement.classList.contains("burger__open")&&document.documentElement.classList.remove("burger__open");var o=t.closest("[data-goto]").dataset.goto,n=document.querySelector(o),c=document.querySelector(".header").offsetHeight;n&&window.scrollTo({top:n.offsetTop-(c+15),behavior:"smooth"}),e.preventDefault()}}var video;function play(){video.play()}function end(){console.log("test"),$(".play-btn").show()}document.addEventListener("click",documentActions),window.onload=function(){video=document.getElementById("myplayer")},$(document).on("click",".play-btn",(function(){$(this).hide(),video.play()})),$(document).ready((function(){}));
